export default function Projects() {
   ...
   <div className="">
    ...
    <img src="src\assets\project_music.jpg" className="rounded border border-dark"></img>
    ...
    <div>
        ...
        <img src="src\assets\project_notes.jpg" className="rounded border border-dark"></img>
    ...
    <div class="project">
        ...
        <img src="src\assets\project_recipe.jpg" className="rounded border border-dark"></img>
